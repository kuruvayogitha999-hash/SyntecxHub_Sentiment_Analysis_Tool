...
- Export trained model and vectorizer  
- Demo prediction cell included  
...
| `sentiment_model.joblib` | Trained ML model (optional if uploaded) |
| `tfidf_vectorizer.joblib` | Saved vectorizer (optional if uploaded) |
...
- **Accuracy:** ~90%  
- Confusion Matrix: (see image included)
